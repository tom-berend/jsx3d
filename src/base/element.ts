...
export class GeometryElement extends Events {
    ...
    */
     ...
     * @type Number
    */
    public elementClass: OBJECT_CLASS
    ...
    */
    ...
    // TODO - where do these actually belong?
    public otype: OBJECT_TYPE        // used to be just 'type' but conflicts with TS
    public oclass: OBJECT_CLASS
    public element
    ...
    */
    ...
    resolveShortcuts(attributes) {
        ...
        for (key in Options.shortcuts) {
            if (Options.shortcuts.hasOwnProperty(key)) {   // tbtb - how can this
