 ...
 */
define(["require", "exports", "../base/constants.js", "../utils/type.js"], function (require, exports, constants_js_1, type_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.GeonextParser = void 0;
    /**
     * Parser helper routines. The methods in here are for parsing expressions in Geonext Syntax.
     * @namespace
     */
    var GeonextParser = /** @class */ (function () {
        function GeonextParser() {
        }
        /**
         ...
         */
        GeonextParser.prototype.replacePow = function (te) {
         ...
         * @returns {String} Converted expression.
         */
        GeonextParser.prototype.replaceIf = function (te) {
         ...
         **/
        GeonextParser.prototype.replaceNameById = function (term, board, jc) {
         ...
         **/
        GeonextParser.prototype.replaceIdByObj = function (term) {
         ...
         */
        GeonextParser.prototype.geonext2JS = function (term, board) {
         ...
         */
        GeonextParser.prototype.findDependencies = function (me, term, board) {
            ...
            for (el in elements) {
                if (elements.hasOwnProperty(el)) {
                    if (el !== me.name) {
                        if (elements[el].elementClass === constants_js_1.OBJECT_CLASS.TEXT) {
         ...
         * @returns {String} Given expression translated to JavaScript.
         */
        GeonextParser.prototype.gxt2jc = function (term, board) {
            var newterm;
            // from = ["Sqrt"],
            // to = ["sqrt"];
            // Hacks, to enable not well formed XML, @see JXG.GeonextReader#replaceLessThan
        ...
        return GeonextParser;
    }());
    exports.GeonextParser = GeonextParser;
});
