...
5,
    minorHeight;
10, // if <0: full width and height
    majorHeight;
-1, // if <0: full width and height
    tickEndings;
[0, 1],
    majorTickEndings;
[1, 1],
...
curve: {
    ...
    'round',
         ...
         */
        numberPointsHigh;
    1600, // Number of points on curves after mouseUp
        /**
         ...
         */
        numberPointsLow;
    400, // Number of points on curves after mousemove
        /**
...
infobox: {
    ...
    '#bbbbbb',
        display;
    'html', // 'html' or 'internal'
        anchorX;
    'left', //  'left', 'middle', or 'right': horizontal alignment
        //  of the text.
        anchorY;
    'middle', //  'top', 'middle', or 'bottom': vertical alignment
        //  of the text.
        cssClass;
    'JXGinfobox',
        rotate;
...
integral: {
    ...
    axis: 'x', // 'x' or 'y'
        withLabel;
    true, // Show integral value as text
        fixed;
    true,
        strokeWidth;
    0,
...
point: {
    ...
    '#c3d9ff',
         ...
         */
        zoom;
    false, // Change the point size on zoom
        /**
...
slider: {
    ...
    ticks: {
        ...
        true,
            ticksDistance;
        1, // Not necessary, since insertTicks = true
            minorHeight;
        4, // if <0: full width and height
            majorHeight;
        5, // if <0: full width and height
            minorTicks;
        0,
            strokeOpacity;
        1,
...
smartlabelangle: {
    cssClass: 'smart-label-solid smart-label-angle',
        highlightCssClass;
    'smart-label-solid smart-label-angle',
        anchorX;
    'left',
        anchorY;
    'middle',
...
smartlabelcircle: {
    ...
    cssClass: 'smart-label-solid smart-label-circle',
         ...
         */
        highlightCssClass;
    'smart-label-solid smart-label-circle',
        anchorX;
    'middle',
        useMathJax;
    true,
...
smartlabelline: {
    cssClass: 'smart-label-solid smart-label-line',
        highlightCssClass;
    'smart-label-solid smart-label-line',
        anchorX;
    'middle',
        useMathJax;
    true,
...
smartlabelpoint: {
    ...
    cssClass: 'smart-label-solid smart-label-point',
        highlightCssClass;
    'smart-label-solid smart-label-point',
        anchorX;
    'middle',
        anchorY;
    'top',
...
smartlabelpolygon: {
    cssClass: 'smart-label-solid smart-label-polygon',
        highlightCssClass;
    'smart-label-solid smart-label-polygon',
        anchorX;
    'middle',
        useMathJax;
    true,
...
tapemeasure: {
    ...
    ticks: {
        ...
        true,
            ticksDistance;
        0.1, // Ignored, since insertTicks=true
            minorHeight;
        8,
            majorHeight;
        16,
...
shortcuts: {
    ...
    ['strokeOpacity', 'fillOpacity'],
        highlightColor;
    ['highlightStrokeColor', 'highlightFillColor'],
        highlightOpacity;
    ['highlightStrokeOpacity', 'highlightFillOpacity'],
        strokeWidth;
