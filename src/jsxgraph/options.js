 ...
 */
define(["require", "exports", "./math/jsxmath.js", "./utils/color.js", "./utils/type.js"], function (require, exports, jsxmath_js_1, color_js_1, type_js_1) {
    "use strict";
    ...
    var Options = /** @class */ (function () {
        ...
        Options.Validator = function () {
            var _this = this;
            var i;
            var validatePixel = function (v) { return (/^[0-9]+px$/).test(v); };
            var validateDisplay = function (v) { return (v === 'html' || v === 'internal'); };
            var validateColor = function (v) { return type_js_1.Type.isString(v); }; // for now this should do it...
            var validatePointFace = function (v) { return type_js_1.Type.exists(_this.normalizePointFace(v)); };
            var validateNumber = function (v) { return type_js_1.Type.isNumber(v, true, false); };
            var validateInteger = function (v) { return (Math.abs(v - Math.round(v)) < jsxmath_js_1.JSXMath.eps); };
            var validateNotNegativeInteger = function (v) { return validateInteger(v) && v >= 0; };
            var validatePositiveInteger = function (v) { return validateInteger(v) && v > 0; };
            // validateScreenCoords = function (v) {
            //     return v.length >= 2 && validateInteger(v[0]) && validateInteger(v[1]);
            // }
            var validateRenderer = function (v) { return (v === 'vml' || v === 'svg' || v === 'canvas' || v === 'no'); };
            var validatePositive = function (v) { return v > 0; };
            var validateNotNegative = function (v) { return v >= 0; };
            var v = {};
            var validators = {
         ...
         * point face.
         */
        Options.prototype.normalizePointFace = function (s) {
            var map = {
                cross: 'x',
                x: 'x',
                circle: 'o',
        ...
        Options.elements = {
            ...
            element3D: null,
            fillColor: color_js_1.Color.palette.red,
            fillOpacity: 1,
            fixed: false,
            frozen: false,
            gradient: null,
            ...
            snapToGrid: false,
            strokeColor: color_js_1.Color.palette.blue,
            strokeOpacity: 1,
            strokeWidth: 2,
            tabindex: -1,
            trace: false,
        ...
        Options.point = {
            ...
            fillColor: color_js_1.Color.palette.red,
            strokeColor: color_js_1.Color.palette.red,
        ...
        Options.angle = {
            ...
            fillColor: color_js_1.Color.palette.orange,
            highlightFillColor: color_js_1.Color.palette.orange,
            strokeColor: color_js_1.Color.palette.orange,
            fillOpacity: 0.3,
            ...
            label: { position: 'top', offset: [0, 0], strokeColor: color_js_1.Color.palette.blue, },
        ...
        Options.boxplot = {
            ...
            strokeWidth: 2,
            strokeColor: color_js_1.Color.palette.blue,
            fillColor: color_js_1.Color.palette.blue,
            fillOpacity: 0.2,
            highlightStrokeWidth: 2,
            highlightStrokeColor: color_js_1.Color.palette.blue,
            highlightFillColor: color_js_1.Color.palette.blue,
        ...
        Options.circumcirclesector = {
            useDirection: true,
            fillColor: color_js_1.Color.palette.yellow,
            highlightFillColor: color_js_1.Color.palette.yellow,
            fillOpacity: 0.3,
            highlightFillOpacity: 0.3,
            strokeColor: color_js_1.Color.palette.blue,
            highlightStrokeColor: '#c3d9ff',
        ...
        Options.integral = {
            ...
            fillColor: color_js_1.Color.palette.red,
            fillOpacity: 0.3,
            highlightFillColor: color_js_1.Color.palette.red,
            highlightFillOpacity: 0.2,
            curveLeft: {
                visible: true,
                withLabel: false,
                color: color_js_1.Color.palette.red,
                fillOpacity: 0.8,
                layer: 9,
            },
            baseLeft: {
        ...
        Options.measurement = {
            ...
            suffix: '',
            dim: null,
            formatCoords: function (self, x, y, z) { return (parseFloat(z) !== 1) ? 'Infinit coords' : '(' + x + ', ' + y + ')'; },
            formatDirection: function (self, x, y) { return '(' + x + ', ' + y + ')'; }
        };
        ...
        */
        ...
        Options.semicircle = {
            center: {
                ...
                highlightStrokeColor: color_js_1.Color.palette.red,
                name: '',
            }
        };
