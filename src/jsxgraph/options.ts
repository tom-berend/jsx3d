...
export class Options {
    ...
    board: {
         ...
         *
         */
        maxBoundingBox: [- 9007199254740991, 9007199254740991, 9007199254740991, - 9007199254740991],  //[Number.MIN_SAFE_INTEGER, Infinity, Infinity, Number.NEGATIVE_INFINITY],
        // TS doesn't like using Number.INFINITY for object initialize
        /**
    ...
    */
     ...
     */
    useStandardOptions(board: Board) {
