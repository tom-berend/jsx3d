...
define(["require", "exports", "./jsxgraph.js"], function (require, exports, jsxgraph_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.JXG = void 0;
    // this file now incorporates parts of constants.js, type.js
    var VERSION = '1.12.1-beta';
    /**
     * JXG is the top object of JSXGraph and defines the namespace
     */
    var JXG = /** @class */ (function (_super) {
        __extends(JXG, _super);
        function JXG() {
         ...
         */
        // shouldn't be needed
        JXG.registerElement = function (element, creator) {
        ...
        //}
        JXG.shortcut = function (obj, funct) {
            return function () {
         ...
         */
        JXG.getBoardByContainerId = function (s) {
            for (var _i = 0, _a = Object.entries(this.boards); _i < _a.length; _i++) {
         ...
         */
        JXG.deprecated = function (what, replacement) {
         ...
         */
        JXG.warn = function (warning) {
            if (typeof window === 'object' && window.console && console.warn) {
                console.warn('WARNING:', warning);
            }
            else if (typeof document === 'object') {
                var warning_1 = document.getElementById('warning');
                if (warning_1) {
                    warning_1.innerHTML += 'WARNING: ' + warning_1 + '<br />';
                }
            }
        };
        /**
         ...
         */
        JXG.licenseText = "JSXGraph v".concat(VERSION, " \u00A9 jsxgraph.org");
        /**
