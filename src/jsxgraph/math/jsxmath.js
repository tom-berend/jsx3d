 ...
 */
define(["require", "exports", "../utils/type.js", "../utils/env.js", "./probfuncs.js"], function (require, exports, type_js_1, env_js_1, probfuncs_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.JSXMath = void 0;
    /**
    ...
    var JSXMath = /** @class */ (function () {
         ...
         */
        JSXMath.wrapAndClamp = function (x, a, b, period) {
         ...
         */
        JSXMath.vector = function (n, init) {
         ...
         */
        JSXMath.matrix = function (n, m, init) {
            if (init === void 0) { init = 0; }
            m = m || n;
            var r = [];
            for (var i = 0; i < n; i++) {
         ...
         */
        JSXMath.identity = function (n, m) {
            m = m || n; // square if not defined
            var r = this.matrix(n, m);
         ...
         */
        JSXMath.frustum = function (l, r, b, t, n, f) {
         ...
         */
        JSXMath.projection = function (fov, ratio, n, f) {
         ...
         * // c === [13, 23];
         */
        JSXMath.matVecMult = function (mat, vec) {
         ...
         * // c === [18, 16];
         */
        JSXMath.vecMatMult = function (vec, mat) {
            var i, k, s, m = mat.length, n = vec.length, res = [];
            if (n === 3) {
                for (i = 0; i < m; i++) {
         ...
         */
        JSXMath.matMatMult = function (mat1, mat2) {
         ...
         * @returns {Array} Two-dimensional Array of numbers containing result
         */
        JSXMath.matNumberMult = function (mat, alpha) {
         ...
         * @returns {Array} Two-dimensional Array of numbers containing result
         */
        JSXMath.matMatAdd = function (mat1, mat2) {
        ...
        JSXMath.inverse = function (Ain) {
            ...
            for (j = 0; j < n; j++) {
                ...
                // Singular matrix
                if (ma <= eps) {
                    env_js_1.Env.warn('JXG.Math.inverse: singular matrix');
                    return [];
                }
                // swap rows:
                if (r > j) {
         ...
         */
        JSXMath.innerProduct = function (a, b, n) {
            var i, s = 0;
            if (n === undefined || !type_js_1.Type.isNumber(n)) {
                n = a.length;
            }
            for (i = 0; i < n; i++) {
                s += a[i] * b[i];
         ...
         */
        JSXMath.crossProduct = function (c1, c2) {
            return [
                c1[1] * c2[2] - c1[2] * c2[1],
                c1[2] * c2[0] - c1[0] * c2[2],
                c1[0] * c2[1] - c1[1] * c2[0]
         ...
         */
        JSXMath.pow = function (base, exponent) {
            if (base === 0) {
                if (exponent === 0) {
                    return 1;
                }
         ...
         * @returns {Number} base to the power of exponent.
         */
        JSXMath.ratpow = function (base, m, n) {
            var g;
            if (m === 0) {
                return 1;
            }
         ...
         */
        JSXMath.log = function (x, b) {
            if (b !== undefined && type_js_1.Type.isNumber(b)) {
         ...
         * @returns {Number} Base to the power of exponent
         */
        JSXMath.squampow = function (base, exponent) {
            var result;
            if (Math.floor(exponent) === exponent) {
         ...
         */
        JSXMath.gcd = function (a, b) {
            var tmp, endless = true;
            a = Math.abs(a);
            b = Math.abs(b);
            if (!(type_js_1.Type.isNumber(a) && type_js_1.Type.isNumber(b))) {
                return NaN;
            }
            if (b > a) {
                tmp = a;
         ...
         */
        JSXMath.roundToStep = function (value, step, min, max) {
         ...
         * @returns {Number}
         */
        JSXMath.erf = function (x) {
            return probfuncs_js_1.ProbFuncs.erf(x);
        };
        /**
         ...
         * @returns {Number}
         */
        JSXMath.erfc = function (x) {
            return probfuncs_js_1.ProbFuncs.erfc(x);
        };
        /**
         ...
         * @returns {Number}
         */
        JSXMath.erfi = function (x) {
            return probfuncs_js_1.ProbFuncs.erfi(x);
        };
        /**
         ...
         * @returns {Number}
         */
        JSXMath.ndtr = function (x) {
            return probfuncs_js_1.ProbFuncs.ndtr(x);
        };
        /**
         ...
         * @returns {Number}
         */
        JSXMath.ndtri = function (x) {
            return probfuncs_js_1.ProbFuncs.ndtri(x);
        };
        /**
         ...
         * // Result: [-1, 10, 2, 3 ]
        */
        JSXMath.decToFraction = function (x, order) {
            var lead, sign, a, n, n1, n2, d, d1, d2, it = 0, maxit = 20;
            order = type_js_1.Type.def(order, 0.001);
            // Round the number.
         ...
         */
        JSXMath.normalize = function (stdform) {
