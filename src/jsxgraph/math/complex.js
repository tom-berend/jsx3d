 ...
 */
define(["require", "exports", "../utils/type.js", "../math/jsxmath.js"], function (require, exports, type_js_1, jsxmath_js_1) {
    "use strict";
    ...
    var Complex = /** @class */ (function () {
        ...
        Complex.prototype.div = function (c) {
            var denom, im, re;
            if (type_js_1.Type.isNumber(c)) {
                if (Math.abs(c) < jsxmath_js_1.JSXMath.eps) {
                    this.real = Infinity;
                ...
                //  (a+ib)(x+iy) = ax-by + i(xb+ay)
                if (Math.abs(c.real) < jsxmath_js_1.JSXMath.eps && Math.abs(c.imaginary) < jsxmath_js_1.JSXMath.eps) {
                    this.real = Infinity;
                    this.imaginary = Infinity;
                    return this;
                }
