...
define(["require", "exports", "../utils/type.js"], function (require, exports, type_js_1) {
    ...
    var ProbFuncs = /** @class */ (function () {
         ...
         * @returns {Number}
         */
        ProbFuncs.expx2 = function (x, sign) {
            // double x;
            // int sign;
            var u, u1, m, f;
            x = Math.abs(x);
         ...
         * @returns {Number}
         */
        ProbFuncs.polevl = function (x, coef, N) {
            var ans, i;
            if (type_js_1.Type.exists(coef.reduce)) {
         ...
         * @returns {Number}
         */
        ProbFuncs.p1evl = function (x, coef, N) {
            var ans, i;
            if (type_js_1.Type.exists(coef.reduce)) {
                return coef.reduce(function (acc, c) {
                    return acc * x + c;
         ...
         * @returns {Number}
         */
        ProbFuncs._underflow = function (a) {
