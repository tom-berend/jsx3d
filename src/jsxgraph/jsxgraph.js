 ...
 */
define(["require", "exports", "./jxg.js", "./utils/env.js", "./utils/type.js", "./base/board.js", "./reader/filereader.js", "./options.js", "./renderer/svg.js"], function (require, exports, jxg_js_1, env_js_1, type_js_1, board_js_1, filereader_js_1, options_js_1, svg_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.JSXGraph = void 0;
    ...
    var JSXGraph = /** @class */ (function () {
        ...
        // }
        JSXGraph.setRendererType = function () {
            options_js_1.Options.board.renderer = 'no';
            if (env_js_1.Env.supportsCanvas()) {
                options_js_1.Options.board.renderer = 'canvas';
            }
            if (env_js_1.Env.supportsSVG()) {
                options_js_1.Options.board.renderer = 'svg';
            }
            // we are inside node
            if (env_js_1.Env.isNode() && env_js_1.Env.supportsCanvas()) {
                options_js_1.Options.board.renderer = 'canvas';
            }
            if (env_js_1.Env.isNode() || options_js_1.Options.renderer === 'no') {
                options_js_1.Options.text.display = 'internal';
                options_js_1.Options.infobox.display = 'internal';
            }
            return options_js_1.Options.board.renderer;
        };
        /**
         ...
         * @private
         */
        JSXGraph.initRenderer = function (box, dim, doc, attrRenderer) {
            var boxid, renderer;
            // Former version:
            // doc = doc || document
            if ((!type_js_1.Type.exists(doc) || doc === false) && typeof document === 'object') {
                doc = document;
            }
            if (typeof doc === 'object' && box !== null) {
                boxid = type_js_1.Type.isString(box) ? doc.getElementById(box) : box;
            ...
            // create the renderer
            if (attrRenderer === 'svg') {
                renderer = new svg_js_1.SVGRenderer(boxid, dim);
            }
        ...
        JSXGraph._setAttributes = function (attributes, options) {
            ...
            for (i = 0; i < len; i++) {
                key = list[i];
                attr[key] = type_js_1.Type.copyAttributes(attr, options, 'board', key);
            }
            attr.navbar = type_js_1.Type.copyAttributes(attr.navbar, options, 'navbar');
            ...
            attr.movetarget =
                attributes.moveTarget ||
                    attributes.movetarget ||
                    options_js_1.Options.board.moveTarget;
            return attr;
        };
        /**
         ...
         * @private
         */
        JSXGraph._fillBoard = function (board, attr, dimensions) {
            ...
            jxg_js_1.JXG.boards[board.id] = board;
        };
        /**
         *
         ...
         * @private
         */
        JSXGraph._setARIA = function (container, attr) {
            ...
            // id_description;
            if (!doc) {
                if (!env_js_1.Env.isBrowser) {
                    return;
                }
                doc = document;
            }
            var node_jsx = type_js_1.Type.isString(container)
         ...
         * @private
         */
        JSXGraph._removeARIANodes = function (board) {
            var node, id, doc;
         ...
         */
        JSXGraph.initBoard = function (box, attributes) {
            ...
            if (attributes.theme !== 'default' &&
                type_js_1.Type.exists(jxg_js_1.JXG.themes[attributes.theme])) {
                theme = jxg_js_1.JXG.themes[attributes.theme];
            }
            options = type_js_1.Type.deepCopy(options_js_1.Options.board, theme);
            attr = this._setAttributes(attributes, options);
            dimensions = env_js_1.Env.getDimensions(box, attr.document);
            if (attr.unitx || attr.unity) {
                originX = type_js_1.Type.def(attr.originx, 150);
                originY = type_js_1.Type.def(attr.originy, 150);
                unitX = type_js_1.Type.def(attr.unitx, 50);
                unitY = type_js_1.Type.def(attr.unity, 50);
            }
            else {
            ...
            if (attr.axis) {
                ...
                axattr_x = type_js_1.Type.deepCopy(options.board.defaultaxes.x, axattr);
                axattr_y = type_js_1.Type.deepCopy(options.board.defaultaxes.y, axattr);
                // The user supplied defaultAxes attributes are merged in.
                if (attr.defaultaxes.x) {
                    axattr_x = type_js_1.Type.deepCopy(axattr_x, attr.defaultaxes.x);
                }
                if (attr.defaultaxes.y) {
                    axattr_y = type_js_1.Type.deepCopy(axattr_y, attr.defaultaxes.y);
                }
                board.defaultAxes = {};
         ...
         * );
         */
        JSXGraph.loadBoardFromFile = function (box, file, format, attributes, callback) {
            ...
            board = new board_js_1.Board(box, renderer, '', [150, 150], 1, 1, 50, 50, dimensions.width, dimensions.height, attr);
            this._fillBoard(board, attr, dimensions);
            encoding = attr.encoding || 'iso-8859-1';
            filereader_js_1.FileReader.parseFileContent(file, board, format, true, encoding, callback);
            return board;
        };
        /**
         ...
         * @see JXG.CinderellaReader
         */
        JSXGraph.loadBoardFromString = function (box, string, format, attributes, callback) {
            ...
            this._setARIA(box, attr);
            /* User default parameters, in parse* the values in the gxt files are submitted to board */
            board = new board_js_1.Board(box, renderer, '', [150, 150], 1.0, 1.0, 50, 50, dimensions.width, dimensions.height, attr);
            this._fillBoard(board, attr, dimensions);
            filereader_js_1.FileReader.parseString(string, board, format, true, callback);
            return board;
        };
        /**
         ...
         *
         */
        JSXGraph.freeBoard = function (board) {
            var el;
            if (typeof board === 'string') {
                board = jxg_js_1.JXG.boards[board];
            }
            ...
            delete jxg_js_1.JXG.boards[board.id];
        };
        /**
         ...
         * @param creator
         */
        JSXGraph.registerElement = function (element, creator) {
            jxg_js_1.JXG.deprecated('JXG.JSXGraph.registerElement()', 'JXG.registerElement()');
            jxg_js_1.JXG.registerElement(element, creator);
        };
        /**
