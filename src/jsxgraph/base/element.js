...
import { OBJECT_CLASS } from "./constants.js";
...
export class GeometryElement extends Events {
     ...
     */
    constructor(board, attributes, type, oclass) {
        super(); // eventify
        /**
    ...
    */
            ...
            if (attributes.hasOwnProperty(i)) {
                ...
                switch (key) {
                    ...
                    case "generatelabelvalue":
                        if (this.type === Const.OBJECT_TYPE_TICKS &&
                    ...
                    case "onpolygon":
                        ...
                        break;
                    case "radius":
                        if (this.type === Const.OBJECT_TYPE_ANGLE ||
    ...
    createLabel() {
        ...
        if (JXG.elements.text) {
            ...
            if (this.visProp.withlabel) {
                this.label = JXG.elements.text(this.board, [
                    0,
                    0,
                    function () {
    ...
    handleSnapToGrid(force, fromParent) {
        ...
        if (needsSnapToGrid) {
            ...
            if (sX > 0 && sY > 0) {
                ...
                if (!attractToGrid ||
                    rcoords.distance(ev_au === "screen" ? JXG.COORDS_BY_SCREEN : JXG.COORDS_BY_USER, this.coords) < ev_ad) {
                    x = rx;
                    y = ry;
    ...
    getBoundingBox() {
        var i, le, v, x, y, r, bb = [Infinity, Infinity, -Infinity, -Infinity];
