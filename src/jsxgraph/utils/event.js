...
define(["require", "exports", "./type.js"], function (require, exports, type_js_1) {
    ...
    var Events = /** @class */ (function () {
        ...
        Events.prototype.trigger = function (event, args) {
            var len1 = event.length;
            for (var j = 0; j < len1; j++) {
                var evt = this.eventHandlers[event[j]];
         ...
         * @returns Reference to the object.
         */
        Events.prototype.on = function (event, handler, context) {
            if (context === void 0) { context = this; }
            // have we initialized this event yet?
            if (!type_js_1.Type.isArray(this.eventHandlers[event])) {
                this.eventHandlers[event] = [];
            }
            context = type_js_1.Type.def(context, this);
        ...
        Events.prototype.off = function (event, handler) {
            ...
            if (!event || !type_js_1.Type.isArray(this.eventHandlers[event])) {
                return this;
            }
            if (handler) {
                var i = type_js_1.Type.indexOf(this.eventHandlers[event], handler, "handler");
                if (i > -1) {
                    // found it
