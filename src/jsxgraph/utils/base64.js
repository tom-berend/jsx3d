 ...
 */
define(["require", "exports", "./encoding.js"], function (require, exports, encoding_js_1) {
    "use strict";
    ...
    */
    var Base64 = /** @class */ (function () {
        ...
        Base64.encode = function (input) {
            ...
            encInput = encoding_js_1.Encoding.encode(input);
            len = encInput.length;
            padLen = len % 3;
        ...
        Base64.decode = function (input, utf8) {
            ...
            output = result.join("");
            if (utf8) {
                output = encoding_js_1.Encoding.decode(output);
            }
            return output;
        };
        /**
         ...
         * @returns {Array}
         */
        Base64.decodeAsArray = function (input) {
