 ...
 */
define(["require", "exports", "./type.js", "./env.js", "../math/jsxmath.js"], function (require, exports, type_js_1, env_js_1, jsxmath_js_1) {
    "use strict";
    ...
    var Color = /** @class */ (function () {
         ...
         */
        Color.rgbParser = function (color, ag, ab) {
            var color_string, channels, re, processor, bits, i, r, g, b, values = color, testFloat;
            if (!type_js_1.Type.exists(color)) {
                return [];
            }
            if (type_js_1.Type.exists(ag) && type_js_1.Type.exists(ab)) {
                values = [color, ag, ab];
            }
            color_string = values;
            testFloat = false;
            if (type_js_1.Type.isArray(color_string)) {
                for (i = 0; i < 3; i++) {
        ...
        ;
        Color.isColor = function (strColor) {
         ...
         */
        Color.rgb2css = function (color, ag, ab) {
            var r;
         ...
         */
        Color.rgb2hex = function (color, ag, ab) {
            var r, g, b;
            r = this.rgbParser(color, ag, ab);
            g = r[1];
            b = r[2];
        ...
        Color.hex2rgb = function (hex) {
            env_js_1.Env.deprecated("JXG.hex2rgb()", "JXG.rgb2css()");
        ...
        Color.hsv2rgb = function (H, S, V) {
            ...
            H = ((H % 360.0) + 360.0) % 360;
            if (S === 0) {
                if (isNaN(H) || H < jsxmath_js_1.JSXMath.eps) {
                    R = V;
                    G = V;
                    B = V;
                }
         ...
         *
         */
        Color.rgb2hsv = function (color, ag, ab) {
         ...
         */
        Color.rgb2LMS = function (color, ag, ab) {
            var r, g, b, l, m, s, ret, 
            // constants
            matrix = [
         ...
         */
        Color.rgbo2rgba = function (rgb, o) {
            var rgba;
         ...
         */
        Color.prototype.rgb2bw = function (color) {
         ...
         * @returns {String} Returns a HTML color string
         */
        Color.rgb2cb = function (color, deficiency) {
         ...
         * @see JXG.shadeColor
         */
        Color.lightenColor = function (color, percent) {
         ...
         * @see JXG.shadeColor
         */
        Color.darkenColor = function (color, percent) {
         ...
         */
        Color.autoHighlight = function (colstr) {
         ...
         */
        Color.contrast = function (hexColor, darkColor, lightColor, threshold) {
         ...
         *
         */
        Color.prototype.setClassicColors = function () {
