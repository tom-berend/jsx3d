 ...
 */
define(["require", "exports", "../base/constants.js", "../options.js"], function (require, exports, constants_js_1, options_js_1) {
    "use strict";
    ...
    var Type = /** @class */ (function () {
         ...
         */
        Type.isNumber = function (v, acceptStringNumber, acceptNaN) {
            if (acceptStringNumber === void 0) { acceptStringNumber = false; }
            if (acceptNaN === void 0) { acceptNaN = true; }
         ...
         * @param v A variable of any type
         */
        Type.isDocumentOrFragment = function (v) {
            return (this.isObject(v) &&
         ...
         * @returns {Boolean} True, if v is of type JXG.Point.
         */
        Type.isPointType = function (board, v) {
            var val, p;
            if (this.isArray(v)) {
                return true;
            }
         ...
         * such an array.
         */
        Type.isPointType3D = function (board, v) {
            var val, p;
         ...
         */
        Type.isTransformationOrArray = function (v) {
            if (v !== null) {
                if (this.isArray(v) && v.length > 0) {
                    return this.isTransformationOrArray(v[0]);
                }
                if (typeof v === 'object') {
                    return v.type === constants_js_1.OBJECT_TYPE.TRANSFORMATION;
                }
            }
            return false;
        };
         ...
         */
        Type.exists = function (v, checkEmptyString) {
            if (checkEmptyString === void 0) { checkEmptyString = false; }
         ...
         */
        Type.cssStringify = function (styles) {
            var str = '', attr, val;
         ...
         */
        Type.eliminateDuplicates = function (a) {
         ...
         * @returns {Array}
         */
        Type.removeElementFromArray = function (ar, el) {
            var i;
         ...
         * @private
         */
        Type._decimalAdjust = function (type, value, exp) {
         ...
         * @private
         */
        Type._round10 = function (value, exp) {
         ...
         * @private
         */
        Type._floor10 = function (value, exp) {
         ...
         * @private
         */
        Type._ceil10 = function (value, exp) {
         ...
         */
        Type.toFixed = function (num, digits) {
         ...
         * @returns {Number}
         */
        Type.prototype.staticautoDigits = function (val) {
         ...
         */
        Type.parseNumber = function (v, percentOfWhat, convertPx) {
            var str;
         ...
         */
        Type.parsePosition = function (str) {
            var a, i, side = '', pos = '';
            str = str.trim();
            if (str !== '') {
                a = str.split(/[ ,]+/);
         ...
         */
        Type.cloneAndCopy = function (obj, obj2) {
            var r, cObj = function () {
                return undefined;
            };
            cObj.prototype = obj;
         ...
         */
        Type.deepCopy = function (obj, obj2, toLower) {
         ...
         *
         */
        Type.mergeAttr = function (attr, special, toLower, ignoreUndefinedSpecials) {
            if (toLower === void 0) { toLower = true; }
            if (ignoreUndefinedSpecials === void 0) { ignoreUndefinedSpecials = false; }
            attr = this.mergeAttrHelper(attr, special, toLower, ignoreUndefinedSpecials);
        };
        // the helper version is testable.
        Type.mergeAttrHelper = function (attr, special, toLower, ignoreUndefinedSpecials) {
            if (toLower === void 0) { toLower = true; }
            if (ignoreUndefinedSpecials === void 0) { ignoreUndefinedSpecials = false; }
            var result = structuredClone(attr); // deep copy
            for (var e in special) {
                if (special.hasOwnProperty(e)) { // only direct properties, not inherited ones
                    var e2 = toLower ? e.toLowerCase() : e;
         ...
         */
        Type.keysToLowerCase = function (obj) {
        ...
        Type.copyAttributes = function (attributes, options) {
            var s = [];
            ...
            if (len < 3 || primitives[s[0]]) {
                ...
                defaultOptions = this.deepCopy(options_js_1.Options.elements, {}, true);
            }
            else {
                defaultOptions = {};
            }
            ...
            for (i = 2; i < len; i++) {
                arg = arguments[i];
                console.log(o, arg);
                var ff = options_js_1.Options.board;
                console.log(ff);
                if (options_js_1.Options[arg]) {
                    o = options_js_1.Options[arg];
                }
                else {
                    isAvail = false;
                    break;
         ...
         * @private
         */
        Type.copyPrototypeMethods = function (subObject, superObject, constructorName) {
            var key;
         ...
         * @deprecated
         */
        Type.toJSON = function (obj, noquote) {
         ...
         */
        Type.clearVisPropOld = function (el) {
            el.visPropOld = {
                cssclass: '',
                cssdefaultstyle: '',
                cssstyle: '',
         ...
         * @returns {Boolean}
         */
        Type.isInObject = function (obj, val) {
            var el;
            for (el in obj) {
         ...
         * @returns {String}
         */
        Type.unescapeHTML = function (str) {
         ...
         * @returns {Array}
         */
        Type.filterElements = function (list, filter) {
         ...
         */
        Type.sanitizeHTML = function (str) {
         ...
         */
        Type.evalSlider = function (s) {
            if (s &&
                s.type === constants_js_1.OBJECT_TYPE.GLIDER &&
         ...
         * @returns String
         */
        Type.stack2jsxgraph = function (str) {
            var t;
            t = str
                .replace(/%pi/g, 'PI')
                .replace(/%e/g, 'EULER')
         ...
         * @returns
         */
        Type.getObjectDiff = function (a, b) {
            var changes = {};
            ...
            for (var _c = 0, _d = Object.keys(a); _c < _d.length; _c++) {
                var key = _d[_c];
                if (!(key in b)) {
                    changes[key] = {
                        expect: a[key],
