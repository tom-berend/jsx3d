 ...
 */
define(["require", "exports", "../jxg.js", "../utils/type.js", "../utils/encoding.js", "../utils/base64.js"], function (require, exports, jxg_js_1, type_js_1, encoding_js_1, base64_js_1) {
    "use strict";
    ...
    var FileReader = /** @class */ (function () {
         ...
         * @private
         */
        FileReader.handleRemoteFile = function (url, board, format, async, encoding, callback) {
            var request;
            try {
            ...
            if (!request) {
                jxg_js_1.JXG.debug("AJAX not activated!");
                return;
            }
            ...
            if (format.toLowerCase() === "raw") {
                ...
                this.cbp = function () {
                    ...
                    if (req.readyState === 4) {
                        ...
                        if (type_js_1.Type.exists(req.responseStream) &&
                            // PK: zip, geogebra
                            // 31: gzip, cinderella
                            (req.responseText.slice(0, 2) === "PK" ||
                                encoding_js_1.Encoding.asciiCharCodeAt(req.responseText.slice(0, 1), 0) === 31)) {
                            // After this, text contains the binary? zip-compressed string
                            text = base64_js_1.Base64.decode(jxgBinFileReader(req));
                        }
                        else {
            ...
            this.cb = type_js_1.Type.bind(this.cbp, this);
            // Old style
         ...
         * @private
         */
        FileReader.handleLocalFile = function (url, board, format, async, encoding, callback) {
            if (!type_js_1.Type.exists(async)) {
                async = true;
            }
            if (format.toLowerCase() === "raw") {
                this.cbp = function (e) {
         ...
         */
        FileReader.parseFileContent = function (url, board, format, async, encoding, callback) {
            if (type_js_1.Type.isString(url) || FileReader === undefined) {
         ...
         * @param {function} callback
         */
        FileReader.parseString = function (str, board, format, callback) {
            var Reader, read;
            format = format.toLowerCase();
            Reader = jxg_js_1.JXG.readers[format];
            if (type_js_1.Type.exists(Reader)) {
            ...
            if (type_js_1.Type.isFunction(callback)) {
                callback(board);
            }
        };
        return FileReader;
