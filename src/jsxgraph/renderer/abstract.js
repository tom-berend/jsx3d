 ...
 */
define(["require", "exports", "../jxg.js", "../options.js", "../base/coords.js", "../math/jsxmath.js", "../math/geometry.js", "../utils/type.js", "../utils/env.js"], function (require, exports, jxg_js_1, options_js_1, coords_js_1, jsxmath_js_1, geometry_js_1, type_js_1, env_js_1) {
    "use strict";
    ...
    var AbstractRenderer = /** @class */ (function () {
         ...
         * @private
         */
        AbstractRenderer.prototype._updateVisual = function (el, not, enhanced) {
         ...
         * @private
         */
        AbstractRenderer.prototype._getHighlighted = function (el) {
            var isTrace = false, hl;
            if (!type_js_1.Type.exists(el.board) || !type_js_1.Type.exists(el.board.highlightedObjects)) {
                // This case handles trace elements.
                // To make them work, we simply neglect highlighting.
                isTrace = true;
            }
            if (!isTrace && type_js_1.Type.exists(el.board.highlightedObjects[el.id])) {
                hl = "highlight";
            }
            else {
                hl = "";
         ...
         * @see JXG.AbstractRenderer#changePointStyle
         */
        AbstractRenderer.prototype.updatePoint = function (el) {
            var size = el.evalVisProp('size'),
            // sometimes el is not a real point and lacks the methods of a JXG.Point instance,
            // in these cases to not use el directly.
            face = options_js_1.Options.normalizePointFace(el.evalVisProp('face')), unit = el.evalVisProp('sizeunit'), zoom = el.evalVisProp('zoom'), s1;
         ...
         * @see JXG.AbstractRenderer#drawPoint
         */
        AbstractRenderer.prototype.changePointStyle = function (el) {
            ...
            // and make a new one
            this.drawPoint(el);
            type_js_1.Type.clearVisPropOld(el);
         ...
         */
        AbstractRenderer.prototype.drawLine = function (el) {
         ...
         */
        AbstractRenderer.prototype.updateLine = function (el) {
         ...
         */
        AbstractRenderer.prototype.drawCurve = function (el) {
         ...
         */
        AbstractRenderer.prototype.updateCurve = function (el) {
            this._updateVisual(el);
            this.updatePathWithArrowHeads(el); // Calls the renderer primitive
            this.setLineCap(el);
        };
         ...
         */
        AbstractRenderer.prototype.updatePathWithArrowHeads = function (el, doHighlight) {
        ...
        AbstractRenderer.prototype.getArrowHeadData = function (el, strokewidth, hl) {
            ...
            */
            if (ev_fa || ev_la) {
                if (type_js_1.Type.exists(ev_fa.type)) {
                ...
                if (type_js_1.Type.exists(ev_la.type)) {
                ...
                if (ev_fa) {
                    size = 6;
                    if (type_js_1.Type.exists(ev_fa.size)) {
                        size = el.eval(ev_fa.size);
                    }
                    if (hl !== "" && type_js_1.Type.exists(ev_fa[hl + "size"])) {
                ...
                if (ev_la) {
                    size = 6;
                    if (type_js_1.Type.exists(ev_la.size)) {
                        size = el.eval(ev_la.size);
                    }
                    if (hl !== "" && type_js_1.Type.exists(ev_la[hl + "size"])) {
         ...
         *
         */
        AbstractRenderer.prototype.updateLineWithEndings = function (el, arrowData) {
            var c1, c2,
            // useTotalLength = true,
            margin = null;
            c1 = new coords_js_1.Coords(jxg_js_1.COORDS_BY.USER, el.point1.coords.usrCoords, el.board);
            c2 = new coords_js_1.Coords(jxg_js_1.COORDS_BY.USER, el.point2.coords.usrCoords, el.board);
            margin = el.evalVisProp('margin');
            geometry_js_1.Geometry.calcStraight(el, c1, c2, margin);
         ...
         *
         */
        AbstractRenderer.prototype.updatePath = function (el) {
         ...
         *
         */
        AbstractRenderer.prototype.getPositionArrowHead = function (el, c1, c2, a) {
            ...
            if (a.evFirst || a.evLast) {
                ...
                d1x = d1y = d2x = d2y = 0.0;
                d = c1.distance(jxg_js_1.COORDS_BY.SCREEN, c2);
                ...
                c1.setCoordinates(jxg_js_1.COORDS_BY.SCREEN, [c1.scrCoords[1] + d1x, c1.scrCoords[2] + d1y], false, true);
                c2.setCoordinates(jxg_js_1.COORDS_BY.SCREEN, [c2.scrCoords[1] - d2x, c2.scrCoords[2] - d2y], false, true);
            }
            return this;
        };
        /**
         ...
         * @see JXG.AbstractRenderer#getArrowHeadData
         */
        AbstractRenderer.prototype.handleTouchpoints = function (el, c1, c2, a) {
         ...
         * @see JXG.AbstractRenderer#getArrowHeadData
         */
        AbstractRenderer.prototype.setArrowSize = function (el, a) {
            if (a.evFirst) {
         ...
         */
        AbstractRenderer.prototype.drawTicks = function (el) {
            el.rendNode = this.appendChildPrim(this.createPrim("path", el.id), el.evalVisProp('layer'));
            this.appendNodesToElement(el, "path");
        };
         ...
         */
        AbstractRenderer.prototype.drawEllipse = function (el) {
         ...
         */
        AbstractRenderer.prototype.updateEllipse = function (el) {
            this._updateVisual(el);
         ...
         */
        AbstractRenderer.prototype.drawPolygon = function (el) {
         ...
         */
        AbstractRenderer.prototype.updatePolygon = function (el) {
         ...
         */
        AbstractRenderer.prototype.drawText = function (el) {
            var node, z, level, ev_visible;
            if (el.evalVisProp('display') === "html" &&
                env_js_1.Env.isBrowser &&
                this.type !== "no") {
            ...
            if (el.visProp.islabel && type_js_1.Type.exists(el.visProp.anchor)) {
         ...
         * @see JXG.AbstractRenderer#updateTextStyle
         */
        AbstractRenderer.prototype.updateText = function (el) {
                    ...
                    if (el.htmlStr !== content) {
                        ...
                        if (el.evalVisProp('usemathjax')) {
                            ...
                            try {
                                ...
                                jxg_js_1.JXG.debug("MathJax (not yet) loaded");
                            }
                        }
                            ...
                            try {
                                ...
                                jxg_js_1.JXG.debug("KaTeX not loaded (yet)");
                            }
                        }
                            ...
                            try {
                                ...
                                jxg_js_1.JXG.debug("AsciiMathML not loaded (yet)");
                            }
                        }
                    }
         ...
         */
        AbstractRenderer.prototype._css2js = function (cssString) {
            var pairs = [], i, len, key, val, s, list = type_js_1.Type.trim(cssString).replace(/;$/, "").split(";");
            len = list.length;
            for (i = 0; i < len; ++i) {
                if (type_js_1.Type.trim(list[i]) !== "") {
                    s = list[i].split(":");
                    key = type_js_1.Type.trim(s[0].replace(/-([a-z])/gi, function (match, char) {
                        return char.toUpperCase();
                    }));
                    val = type_js_1.Type.trim(s[1]);
         ...
         */
        AbstractRenderer.prototype.updateTextStyle = function (el, doHighlight) {
            var fs, so, sc, css, node, display = env_js_1.Env.isBrowser ? el.visProp.display : "internal", nodeList = ["rendNode", "rendNodeTag", "rendNodeLabel"], lenN = nodeList.length, fontUnit = el.evalVisProp('fontunit'), cssList, prop, style, cssString, styleList = ["cssdefaultstyle", "cssstyle"], lenS = styleList.length;
            if (doHighlight) {
            ...
            if (this.type !== "no" && (display === "html" || this.type !== "canvas")) {
                for (style = 0; style < lenS; style++) {
                    ...
                    for (node = 0; node < lenN; node++) {
                        if (type_js_1.Type.exists(el[nodeList[node]])) {
         ...
         */
        AbstractRenderer.prototype.updateImage = function (el) {
         ...
         */
        AbstractRenderer.prototype.joinTransforms = function (el, transformations) {
            ...
            for (i = 0; i < len; i++) {
                m = jsxmath_js_1.JSXMath.matMatMult(transformations[i].matrix, m);
            }
            // Scale back and then translate back
            m = jsxmath_js_1.JSXMath.matMatMult([
                [1, 0, 0],
                [ox, ux, 0],
                [oy, 0, -uy]
            ], m);
         ...
         */
        AbstractRenderer.prototype.updateImageStyle = function (el, doHighlight) {
         ...
         * @see JXG.AbstractRenderer#updateTextStyle
         */
        AbstractRenderer.prototype.highlight = function (el, suppressHighlightStrokeWidth) {
            var i, do_hl, sw;
            this.setObjectTransition(el);
            if (!el.visProp.draft) {
         ...
         * @see JXG.AbstractRenderer#updateTextStyle
         */
        AbstractRenderer.prototype.noHighlight = function (el) {
            var i, sw;
            this.setObjectTransition(el);
            if (!el.evalVisProp('draft')) {
                if (el.type === OBJECT_TYPE.POLYGON) {
         ...
         */
        AbstractRenderer.prototype.removeDraft = function (el) {
            this.setObjectTransition(el);
            if (el.type === OBJECT_TYPE.POLYGON) {
                this.setObjectFillColor(el, el.evalVisProp('fillcolor'), el.evalVisProp('fillopacity'));
            }
         ...
         */
        AbstractRenderer.prototype.setDraft = function (el) {
            if (!el.evalVisProp('draft')) {
                return;
            }
         ...
         * @private
         */
        AbstractRenderer.prototype.drawNavigationBar = function (board, attr) {
            ...
            createButton = function (label, handler, board_id, type) {
                ...
                env_js_1.Env.addEvent(button, "click", function (e) {
                    type_js_1.Type.bind(handler, board)();
                    return false;
                }, board);
                // prevent the click from bubbling down to the board
                env_js_1.Env.addEvent(button, "pointerup", cancelbubble, board);
                env_js_1.Env.addEvent(button, "pointerdown", cancelbubble, board);
                env_js_1.Env.addEvent(button, "pointerleave", cancelbubble, board);
                env_js_1.Env.addEvent(button, "mouseup", cancelbubble, board);
                env_js_1.Env.addEvent(button, "mousedown", cancelbubble, board);
                env_js_1.Env.addEvent(button, "touchend", cancelbubble, board);
                env_js_1.Env.addEvent(button, "touchstart", cancelbubble, board);
            };
            if (env_js_1.Env.isBrowser && this.type !== "no") {
         ...
         */
        AbstractRenderer.prototype.getElementById = function (id) {
            var str;
            if (type_js_1.Type.exists(this.container)) {
                ...
                if (type_js_1.Type.exists(CSS) && type_js_1.Type.exists(CSS.escape)) {
                    str = CSS.escape(str);
                }
         ...
         */
        AbstractRenderer.prototype.removeToInsertLater = function (el) {
